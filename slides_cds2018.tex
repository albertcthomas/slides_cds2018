...
\mintinline{python}{EllipticEnvelope}, \mintinline{python}{OneClassSVM} and \mintinline{python}{IsolationForest}
...
\mintinline{python}{LocalOutlierFactor}, based on \mintinline{python}{k}-NN distances
...
\visible<2->{
\begin{center}
\textbf{Cannot (officialy) use \mintinline{python}{LocalOutlierFactor} for novelty detection}
\end{center}
\begin{center}
\includegraphics[width=2cm]{img/shocking.jpg}
\end{center}
}
...
\onslide<1->{
\mintinline{python}{contamination} parameter in $(0, 1)$ (\mintinline{python}{nu} for \mintinline{python}{OneClassSVM})
